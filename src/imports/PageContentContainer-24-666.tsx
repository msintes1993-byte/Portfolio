...
function ContentLeft() {
  return (
    <div className="content-stretch flex flex-col gap-[63px] items-start relative shrink-0" data-name="content-left">
      <Hero />
...
function ContentRight() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[542px]" data-name="content-right">
      <div className="h-[379px] relative shadow-[0px_10px_6.5px_0px_rgba(0,0,0,0.15)] shrink-0 w-full" data-name="image 12">
...
export default function PageContentContainer() {
  return (
    <div className="content-stretch flex items-center justify-between relative size-full" data-name="page-content-container">
      <ContentLeft />
      <ContentRight />
    </div>
  );
